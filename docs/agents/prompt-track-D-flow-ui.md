...
1. Les [docs/contracts/room-runtime.md](../contracts/room-runtime.md) (manifest `default_room_id`).
2. Les [docs/CATSPY_ROOM_FLOW_SPEC.md](../CATSPY_ROOM_FLOW_SPEC.md) §15 Room 1 (celle) for tone i tekster.
